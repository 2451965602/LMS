...
type User struct {
	...
	Permissions  string    `json:"permissions"   gorm:"type:enum('admin','librarian','member');default:'member';not null"`
	Phone        *string   `json:"phone"         gorm:"type:varchar(20)"`
	RegisterDate time.Time `json:"register_date" gorm:"type:timestamp;default:CURRENT_TIMESTAMP;not null"`
...
type BookType struct {
	...
	PublishYear     *int   `json:"publish_year"     gorm:"type:int"`
	Description     string `json:"description"      gorm:"type:text"`
	TotalCopies     int    `json:"total_copies"     gorm:"type:int;default:0;not null"`
	AvailableCopies int    `json:"available_copies" gorm:"type:int;default:0;not null"`
}
...
type Book struct {
	...
	Status        string     `json:"status"         gorm:"type:enum('available','checked_out','reserved','lost','damaged');default:'available'"`
